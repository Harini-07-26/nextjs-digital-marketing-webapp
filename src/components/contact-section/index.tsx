...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="container mt-5 pt-5 py-24 bg-background transition-colors duration-300 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 py-12 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-foreground font-medium">Chennai, TN</span>
                </div>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            {status === 'success' ? (
              <div className="bg-card border border-border rounded-2xl p-10 text-center space-y-6 shadow-lg max-w-lg mx-auto lg:mr-0 lg:ml-auto">
                ...
                <button
                  ...
                  className="btn-primary-gradient mt-4 inline-flex items-center gap-2 px-6 py-3 text-sm"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6 max-w-lg mx-auto lg:mr-0 lg:ml-auto">
                {status === 'error' && (
                  <div className="bg-rose-500/10 border border-rose-500/30 text-rose-500 rounded-xl p-4 flex items-start gap-3">
                ...
                <button
                  ...
                  className="btn-primary-gradient w-full py-3.5 text-sm font-semibold inline-flex items-center justify-center gap-2"
                >
                  {status === 'submitting' ? (
                    <>
